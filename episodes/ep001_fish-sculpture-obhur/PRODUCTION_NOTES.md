...
Classification standard for this episode: **Required** (production cannot start without it) / **Recommended** (improves quality, does not block) / **Optional** (can be added later).
...
- [ ] Voice generated from approved model (Veo Character voice)
- [ ] Voice reviewed against `SARA_VOICE_BIBLE.md` — pacing and delivery natural
- [ ] Issues resolved through script changes (not model changes)
...
- [ ] Visuals and voice combined
- [ ] Pacing reviewed
- [ ] No music — silence intended for closing beat, per `SARA_PRODUCTION_RULES.md`
